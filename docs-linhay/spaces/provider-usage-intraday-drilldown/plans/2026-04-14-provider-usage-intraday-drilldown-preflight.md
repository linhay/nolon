...
- `docs-linhay/spaces/provider-usage-intraday-drilldown/debate/20260414/codex-usage/20260414-intraday-usage-curve-v01.md`

## 开始执行前的固定前提

1. 以 `docs-linhay/spaces/provider-usage-intraday-drilldown/README.md` 作为最新需求规格。
