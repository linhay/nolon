...
## 后续扩展
- HTTP 用量查询能力已单独落到 [codex-http-usage-query-2026-03-07.md](/Users/linhey/Desktop/FlowUp-Libs/nolon/docs-linhay/spaces/codex-http-usage-query/README.md)，并作为配置型卡片的可选能力接在 Codex CLI 用量链路前面。
