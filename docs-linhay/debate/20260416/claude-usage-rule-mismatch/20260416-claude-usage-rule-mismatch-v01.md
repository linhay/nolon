...
- 论点：当前产品统计的不是官方上游 usage 口径，而是“本地 Claude session 日志聚合”。
  → 引用：`docs-linhay/features/provider-account-usage-tab-split-2026-04-16.md:35`
...
| # | 事实 | 来源 |
|---|------|------|
| 1 | Claude Usage 页明确不走 web usage API，而是扫描本地 session 日志 | `docs-linhay/features/provider-account-usage-tab-split-2026-04-16.md:35` |
