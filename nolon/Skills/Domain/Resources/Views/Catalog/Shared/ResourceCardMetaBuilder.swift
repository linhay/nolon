...
enum ResourceCardMetaBuilder {
    static func skillItems(_ skill: RemoteSkill) -> [NolonUI.ResourceCardMetaItem] {
        var items: [NolonUI.ResourceCardMetaItem] = []
    ...
    static func workflowItems(_ workflow: RemoteWorkflow) -> [NolonUI.ResourceCardMetaItem] {
        var items: [NolonUI.ResourceCardMetaItem] = []
    ...
    static func mcpItems(_ mcp: RemoteMCP) -> [NolonUI.ResourceCardMetaItem] {
        var items: [NolonUI.ResourceCardMetaItem] = []
