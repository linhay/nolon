        ...
        Group {
            if let skill = skill {
                ...
                ContentUnavailableView(
                    ...
                    description: Text(NSLocalizedString("detail.no_selection_desc", comment: "Select a skill to view its details"))
                )
            }
        }
    }
            ...
            ToolbarItem(placement: .primaryAction) {
                Menu {
                    Button {
                        ...
                        Label(
                            NSLocalizedString("detail.open_folder", comment: "Open in Finder"),
                            systemImage: "folder"
                        )
                    }
                } label: {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            LazyVGrid(columns: [
                ...
                MetadataItem(
                    ...
                    value: "\(skill.referenceCount) \(NSLocalizedString("detail.files", comment: "files"))"
                )
