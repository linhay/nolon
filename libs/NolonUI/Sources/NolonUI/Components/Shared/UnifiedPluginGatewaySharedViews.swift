...
// MARK: - GatewayAccountCandidateListView.swift"
...
public struct GatewayAccountCandidateListView: View {
    ...
    public struct Config {
        public var sections: [GatewayAccountCandidateSectionData]
...
// MARK: - GatewayCardPickerSheetView.swift"

public struct GatewayCardPickerSheetView: View {
    public struct Config {
        public var data: GatewayCardPickerSheetData
